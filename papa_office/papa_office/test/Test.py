...
from papa_office.rocket.exception.RocketExceptions import RocketAuthenticationException, RocketMissingParamException
from papa_office.rocket.Rocketchat import  RocketChat
...
class TestUsers(unittest.TestCase):
    ...
    def test_users_set_avatar_from_url(self):
        ...
        self.skipTest("possible API bug on users.setAvatar when using avatarUrl")
